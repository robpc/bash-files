...
override_git_prompt_colors() {
  ...
  GIT_PROMPT_START_USER="${ResetColor}[${Blue}\u@\h:${PathShort}${ResetColor}]"
  # GIT_PROMPT_START_ROOT="_LAST_COMMAND_INDICATOR_ ${GIT_PROMPT_START_USER}"
  GIT_PROMPT_END_USER=" \n${White}${Time12a}${ResetColor} _LAST_COMMAND_INDICATOR_ $ ${ResetColor}"
...
reload_git_prompt_colors "robpc"
